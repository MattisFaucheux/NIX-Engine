	...
	*/
	struct Vector3
	{
		...
		*/
		...
		bool Equal(const Vector3& other) { return x == other.x && y == other.y && z == other.z; }
		Vector3 Add(const Vector3& other) { return Vector3(x + other.x, y + other.y, z + other.z); }
		Vector3 Sub(const Vector3& other) { return Vector3(x - other.x, y - other.y, z - other.z); }
		Vector3 Multiply(const Vector3& other) { return Vector3(x * other.x, y * other.y, z * other.z); }
		Vector3 Divide(const Vector3& other) { return Vector3(x / other.x, y / other.y, z / other.z); }
		Vector3& AddEqual(const Vector3& other) { x += other.x; y += other.y; z += other.z;  return *this; }
		Vector3& SubEqual(const Vector3& other) { x -= other.x; y -= other.y; z -= other.z;  return *this; }
		Vector3& MultiplyEqual(const Vector3& other) { x *= other.x; y *= other.y; z *= other.z;  return *this; }
		Vector3& DivideEqual(const Vector3& other) { x /= other.x; y /= other.y; z /= other.z;  return *this; }
