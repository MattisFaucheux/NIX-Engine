	...
	*/
	struct Vector4
	{
		...
		*/
		...
		bool Equal(const Vector4& other) { return x == other.x && y == other.y && z == other.z && w == other.w; }
		Vector4 Add(const Vector4& other) { return Vector4(x + other.x, y + other.y, z + other.z, w + other.w); }
		Vector4 Sub(const Vector4& other) { return Vector4(x - other.x, y - other.y, z - other.z, w - other.w); }
		Vector4 Multiply(const Vector4& other) { return Vector4(x * other.x, y * other.y, z * other.z, w * other.w); }
		Vector4 Divide(const Vector4& other) { return Vector4(x / other.x, y / other.y, z / other.z, w / other.w); }
		Vector4& AddEqual(const Vector4& other) { x += other.x; y += other.y; z += other.z; w += other.w;  return *this; }
		Vector4& SubEqual(const Vector4& other) { x -= other.x; y -= other.y; z -= other.z; w -= other.w;  return *this; }
		Vector4& MultiplyEqual(const Vector4& other) { x *= other.x; y *= other.y; z *= other.z; w *= other.w;  return *this; }
		Vector4& DivideEqual(const Vector4& other) { x /= other.x; y /= other.y; z /= other.z; w /= other.w; return *this; }
